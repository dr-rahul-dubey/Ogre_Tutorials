...
bool TutorialApplication::go()
{
  ...
  Ogre::SceneNode* ogreNode = mSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(0, 100, -200));
  ogreNode->attachObject(ogreEntity);

  /*Ogre::Entity* ogreEntityFixed = mSceneMgr->createEntity("robot.mesh");
    Ogre::SceneNode* sceneNode = mSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(0, 0, -200));
